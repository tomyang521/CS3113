...
SpriteSheet::SpriteSheet(GLuint textureID, unsigned int spriteX, unsigned int spriteY, unsigned int index) :
textureID(textureID), spriteX(spriteX), spriteY(spriteY), index(index) {}
